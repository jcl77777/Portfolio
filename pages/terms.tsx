...
function TermsContent() {
  ...
  const sections = [
    ...
    { key: 'services', ...t.terms.sections.services },
    { key: 'subscriptions', ...t.terms.sections.subscriptions },
    { key: 'userConduct', ...t.terms.sections.userConduct },
    { key: 'intellectualProperty', ...t.terms.sections.intellectualProperty },
    { key: 'disclaimers', ...t.terms.sections.disclaimers },
    { key: 'privacy', ...t.terms.sections.privacy },
    { key: 'changes', ...t.terms.sections.changes },
    { key: 'governing', ...t.terms.sections.governing },
  ...
  return (
    <>
      <Head>
        <title>{t.terms.title} | Certo</title>
        <meta name="description" content={t.terms.sections.acceptance.content[0]} />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://nannovalabs.com/terms/" />
        <meta property="og:title" content={`${t.terms.title} | Certo`} />
        <meta property="og:description" content={t.terms.sections.acceptance.content[0]} />
        <meta property="og:locale" content={locale === 'zh-TW' ? 'zh_TW' : 'en_US'} />

        {/* Twitter */}
        <meta property="twitter:card" content="summary" />
        <meta property="twitter:title" content={`${t.terms.title} | Certo`} />
        <meta property="twitter:description" content={t.terms.sections.acceptance.content[0]} />
      </Head>
